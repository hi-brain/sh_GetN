...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/wix:Wix">
    <Wix xmlns="http://schemas.microsoft.com/wix/2006/wi">
      <Product xmlns="http://schemas.microsoft.com/wix/2006/wi" Id="82965759-C06F-4349-BA0E-3CF65621AC93" Name="sh_GetN " Language="1041" Codepage="932" Version="" Manufacturer="VenderName" UpgradeCode="FD8FEBCD-BA5B-4EAB-89E2-220A0CD22BF5">
        <Package InstallerVersion="300" Compressed="yes" Languages='1041' SummaryCodepage='932' />
        <Media Id="1" Cabinet="sh_GetN.cab" EmbedCab="yes" />
	  ...
	  -->
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\bin\sh_GetN.dll','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\lib\sh_GetN.lib','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\bin\sh_GetNComp.exe','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, 'RTC.xml')]" />
        </Feature>
	...
	<!-- <Feature Id="SOURCES" Title="" Level="1" Absent="allow" Description="" >-->
          <!-- Start Ripping through the xml -->
	  <!-- <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, 'sh_GetN100\src')]" /> -->
	  <!-- </Feature> -->
        ...
        <!-- 
        <WixVariable Id="WixUILicenseRtf" Value="C:/Users/urabe/OpenRTM/workspace/comp1.1v64b/shmodels/sh_GetN/cmake/License.rtf"/>
        -->
