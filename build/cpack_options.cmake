...
set(CPACK_PACKAGE_FILE_NAME "sh_GetN-1.0.0")
set(CPACK_RESOURCE_FILE_LICENSE "C:/Users/urabe/OpenRTM/workspace/comp1.1v64b/shmodels/sh_GetN/COPYING.LESSER")
...
IF (WIN32)
    ...
    set(CPACK_RESOURCE_FILE_LICENSE
        "C:/Users/urabe/OpenRTM/workspace/comp1.1v64b/shmodels/sh_GetN/cmake/License.rtf")
    configure_file(
        "C:/Users/urabe/OpenRTM/workspace/comp1.1v64b/shmodels/sh_GetN/cmake/wix.xsl.in"
        "C:/Users/urabe/OpenRTM/workspace/comp1.1v64b/shmodels/sh_GetN/build/wix.xsl" @ONLY)
    ...
    if(INSTALL_DOCUMENTATION)
        set(CPACK_NSIS_MENU_LINKS
            "C:/Program Files/sh_GetN/share/doc/sh_getn-1/html/index.html"
            "Component documentation")
    endif(INSTALL_DOCUMENTATION)
    string(REPLACE "/sh_GetN" "" install_prefix_root
        "C:/Program Files/sh_GetN")
    file(TO_NATIVE_PATH "${install_prefix_root}" install_prefix_root)
    set(CPACK_NSIS_INSTALL_ROOT "${install_prefix_root}")
    set(CPACK_NSIS_EXTRA_INSTALL_COMMANDS
        "  Rename \"$INSTDIR\\share\\sh_getn-1\\sh_getn-config.cmake\" \"$INSTDIR\\sh_getn-config.cmake\"
  Rename \"$INSTDIR\\share\\sh_getn-1\\sh_getn-config-version.cmake\" \"$INSTDIR\\sh_getn-config-version.cmake\"")
    set(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS
        "  Delete \"$INSTDIR\\sh_getn-config.cmake\"
